...
public class PurchasesCriteriaController implements Initializable {
    ...
    public String getProject(){return psProjectCd;}
    ...
    private void loadRecord(){
        ...
        XMProject instance = new XMProject(oApp, oApp.getBranchCode(), true);
        if (instance.browseRecord(oApp.getBranchCode(), true)){
            psProjectCd = (String) instance.getMaster("sProjCode");
